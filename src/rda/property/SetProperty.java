...
public interface SetProperty {
    ...
    //Server Property
    /**
     * file:server.property h1.server=h1\:2809 h0.server=localhost\:2809
     * number.server=1 number.thread=16
     */
    ...
    //Queue Property
    /**
     * file:queue.property size.window number.queue length.queue wait.queue
     */
    ...
    //Agent Property
    /**
     * file:agent.property number.user.agent time.period wait.agent time.run
     * time.delay number.rank.agent
     */
    ...
    public static final Integer AGENT_DEPLOY_PATTERN = Integer.valueOf(prop.getValue("agent", "agent.deploy.pattern"));

    //Log Property
    /**
     * log.dir=logs/ log.file=AgentSystem_info log.history=history/
     * file.agent=MQLength file.event=MQEvent file.cpu=vmstat
     * file.results=AgentResults file.all=ALLData
     */
